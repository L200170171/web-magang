      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header">
            <a class="btn btn-success" data-toggle="modal" data-target="#myModal" style="color: white;"><span class="fa fa-plus"></span> Add pengumuman</a>
          </div>
          <!-- /.card-header -->
          <div class="card-body">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td style="text-align:center;">
                        ...
                        <a class="btn" href="<?= base_url('admin/a_pengumuman/hapus/').$id;?>" onClick="return doconfirm();" ><span class="fa fa-trash"></span></a>
                  </td>
                </tr>
                <?php endforeach;?>
              </tbody>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <form class="form-horizontal" action="<?php echo site_url()?>admin/a_pengumuman/insert" method="post" enctype="multipart/form-data">
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <form class="form-horizontal" action="<?php echo site_url()?>admin/a_pengumuman/update/<?php echo $id?>" method="post" enctype="multipart/form-data">
