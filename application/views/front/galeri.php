...
<html>
	...
	<title>Galeri SD Negeri Kadipaten 2</title>
	...
	<link rel="stylesheet" href="<?= base_url('asset/')?>dist/fancy/jquery.fancybox.min.css">
				...
				<div class="row">
					...
					<div class="col-xs-9 text-right menu-1">
						<ul>
							...
							<li <?php if($judul=="Galeri"){echo "class='active'";}?> ><a href="<?= base_url('Galeri')?>">Galeri</a></li>
						</ul>
					</div>
				</div>
			</div>
	...
	<aside id="fh5co-hero">
		<div class="flexslider">
			<ul class="slides">
		   	<li style="background-image: url(<?= base_url('asset/')?>foto/galeri/13.jpg);">
		   		<div class="overlay-gradient"></div>
		   		<div class="container">
		   			<div class="row">
			   			<div class="col-md-8 col-md-offset-2 text-center slider-text">
			   				<div class="slider-text-inner">
			   					<h1 class="heading-section">Galeri Foto</h1>
			...
			?>
				<div class="col-lg-4 col-md-4">
					<div class="fh5co-blog animate-box">
						<a href="<?php echo base_url()?>asset/foto/galeri/<?= $gambar?>" data-fancybox="grup" data-caption="<?= $judul ?>" class="blog-img-holder" style="background-image: url(<?= base_url('asset/')?>foto/galeri/<?= $gambar?>);"></a>
					</div>
				</div>
			<?php endforeach ?>
			</div>
    ...
    <script src="<?= base_url('asset/')?>dist/fancy/jquery.fancybox.min.js"></script>
	<script>
