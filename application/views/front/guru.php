...
<html>
	...
	<title>Direktori Guru SDN Kadipaten 2</title>
	...
	<aside id="fh5co-hero">
		<div class="flexslider">
			<ul class="slides">
		   	<li style="background-image: url(<?= base_url("asset/")?>foto/galeri/11.jpg);">
		   		<div class="overlay-gradient"></div>
		   		<div class="container">
		   			<div class="row">
			   			<div class="col-md-8 col-md-offset-2 text-center slider-text">
			   				<div class="slider-text-inner">
			   					<h1 class="heading-section">Direktori Guru</h1>
	...
	<div id="fh5co-staff">
		<div class="container">
			<div class="row">
				...
				<div class="col-md-3">
					<div class="staff">
						<div class="staff-img" style="background-image: url(<?= base_url("asset/")?>foto/guru/<?= $poto ?>);">
						</div>
						<span><?= $mapel ?></span>
						<h3><a href="#"><?= $nama ?></a></h3>
