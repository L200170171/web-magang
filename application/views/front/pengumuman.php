...
<html>
	...
	<title>Pengumuman SDN Kadipaten 2</title>
						...
						<ul>
							...
							<li class="has-dropdown">
								...
								<ul class="dropdown">
									...
									<li class="active" <?php if($judul=="Pengumuman")?> ><a href="<?= base_url('Pengumuman')?>">Pengumuman</a></li>
			...
			<div class="row animate-box">
				<?php
					...
					foreach ($data->result() as $i) :
						...
						$tanggal=date_create($i->pengumuman_tanggal);        
				?>
				<div class="col-md-4 animate-box">
					<div class="fh5co-event">
						<div class="date text-center"><span><?= date_format($tanggal,'j'); ?><br><?= date_format($tanggal,'F'); ?></span></div>
