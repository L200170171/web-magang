...
<html>
	...
	<title>Direktori Siswa SDN Kadipaten 2</title>
	...
	<aside id="fh5co-hero">
		<div class="flexslider">
			<ul class="slides">
		   	<li style="background-image: url(<?= base_url('asset/')?>foto/galeri/1.jpg);">
		   		<div class="overlay-gradient"></div>
		   		<div class="container">
		   			<div class="row">
			   			<div class="col-md-8 col-md-offset-2 text-center slider-text">
			   				<div class="slider-text-inner">
			   					<h1 class="heading-section">Direktori Siswa</h1>
		...
		<div class="container">
			...
			<?php
				...
				foreach ($data->result() as $row) :
					...
					$jk = $row->siswa_jenkel;
					$kls = $row->kelas_nama;
					$poto = $row->siswa_photo;
			?>
				<div class="col-md-3 text-center">
					<div class="staff">
						<div class="staff-img" style="background-image: url(<?= base_url('asset/')?>foto/siswa/<?= $poto ?>);">
						</div>
						<h3><a href="#"><?= $nama ?></a></h3>
